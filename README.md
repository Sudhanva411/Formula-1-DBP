...
<img width="1448" height="1086" alt="Formula 1 Data Engineering Pipeline Architecture" src="https://github.com/user-attachments/assets/47bff3b8-911a-4dca-881f-229dddeb82f2" />
...
<img width="1448" height="1086" alt="Formula 1 Gold Layer Data Model" src="https://github.com/user-attachments/assets/3b51c995-a422-484f-b84a-8e7cdb4d6f3d" />

The Gold layer follows a dimensional modeling approach with:

- Driver dimension
- Race dimension
- Constructor dimension
- Session results fact table
- Nationality-to-region reference table

The `fact_session_results` table brings together race and sprint results while connecting them to the relevant race, driver, and constructor dimensions.
